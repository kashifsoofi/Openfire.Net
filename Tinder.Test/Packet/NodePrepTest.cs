 ...
 */
	 ...
	 * node-prepping gets prepped without a problem.
	 */
		@Test
		public void testValidString() throws Exception {
			...
			// do magic
			final String result = JID.nodeprep(node);
		...
		/**
	 * Checks that node-prepping is case insensitive.
	 */
		@Test
	 ...
	 */
		...
		public void testMapping() throws Exception {
			...
			// do magic
			final String result = JID.nodeprep(input);
